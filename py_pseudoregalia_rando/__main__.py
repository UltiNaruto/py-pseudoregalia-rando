...
parser.add_argument("game_path", type=String, help="Path to the JSON file to pass to the config file.")
args = parser.parse_args()

py_pseudoregalia_rando.patch_game(args.json_file.read_text("utf-8"), args.game_path, )